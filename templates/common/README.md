...
Django project scaffolded with [pi-django](https://pi.dev/packages), following the
conventions of `STILE-DJANGO.md` (services/selectors domain layer, UUID primary keys,
`config/django` settings package, uv + ruff + pytest).
...
- Lint/format: ruff (STILE-DJANGO.md §2.2)
